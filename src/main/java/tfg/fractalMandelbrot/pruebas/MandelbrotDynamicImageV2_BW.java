...
public class MandelbrotDynamicImageV2_BW extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MandelbrotDynamicImageV2_BW frame = new MandelbrotDynamicImageV2_BW();
	 ...
	 * Create the frame.
	 */
	public MandelbrotDynamicImageV2_BW() {
