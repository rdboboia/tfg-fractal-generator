 ...
 * @author -$BOSS$-
 */
public class SingleThreadBenchmarkPanel extends JPanel {
	/**
	 ...
	 * component's name. 
	 */
	public static final String NAME = SingleThreadBenchmarkPanel.class.getSimpleName();
	 ...
	 */
	public SingleThreadBenchmarkPanel() {
		...
		if (btnStart.isEnabled()) {
			...
			Thread generatorThread = new Thread() {
				...
				public void run() {
					...
					s = System.currentTimeMillis(); // Start time
					sTotal = s;
					MandelbrotsetGeneratorThreadManager.generate(image, 36000, 360, position, 1);
					f = System.currentTimeMillis(); // Finish time
